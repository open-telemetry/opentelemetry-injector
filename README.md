...
Official RPM and DEB packages that bundle the injector together with the Java, Node.js, and .NET auto-instrumentation
agents are built and published from the
